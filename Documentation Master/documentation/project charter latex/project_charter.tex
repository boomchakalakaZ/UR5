...
\newcommand{\authors}{Anthony Tatowicz \\ Jesse Mitchell \\ Todd Brewer\\ Linh Vu}
...
\begin{versionhistory}
  	\vhEntry{0.1}{10.02.2017}{LV}{Creating document}
  	\vhEntry{0.1}{10.02.2017}{LV}{New Entry example}
\end{versionhistory}
\newpage
