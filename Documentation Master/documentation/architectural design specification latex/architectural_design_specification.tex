...
\begin{versionhistory}
  	...
  	\vhEntry{0.2}{5.09.2018}{LV, TB}{Revise documents, add pictures}
  	\vhEntry{0.3}{5.11.2018}{TB}{Final Draft}
\end{versionhistory}
\newpage
...
\input{tex/network_layer_subsystems.tex}
\newpage
\section{Control Layer Subsystems}
\input{tex/control_layer_subsystems.tex}
\newpage
\section{UR5 Layer Subsystems}
\input{tex/UR5_layer_subsystems.tex}
\newpage
\section{Mount Layer Subsystems}
\input{tex/mount_layer_subsystems.tex}
\newpage
